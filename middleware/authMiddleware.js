...
const { userModel, adminModel, merchantModel } = require("../models");
...
const merchantsAuthMiddleware = authMiddleware(
  merchantModel,
  "NOT_ADMIN_SESSION",
  "merchant"
);

module.exports = { usersAuthMiddleware, adminsAuthMiddleware, merchantsAuthMiddleware };
